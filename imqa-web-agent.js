...
var CrashWindowManager = /** @class */function () {
  ...
  CrashWindowManager.run = function () {
    window.onerror = function myErrorHandler(message, file, line, column, errorObj) {
      ...
      // if (isSafari) new IOSCrash(message, file, line, column, errorObj, screenName, webviewTxId);
      new IOSCrash_1.IOSCrash(message, file, line, column, errorObj, screenName, webviewTxId);
