...
var IMQAAgent = /** @class */function () {
  ...
  IMQAAgent.prototype.sendError = function (data) {
    ...
    if (typeof IMQAJSModel !== "undefined") {
      // IOS에서 브릿지를 열수 없을 경우 IMQAJSModel을 통해 보냄
      // @ts-ignore
      IMQAJSModel.sendError(JSON.stringify(data));
    } else {
...
var Header = /** @class */function () {
  ...
  Header.prototype.set = function (config) {
    ...
    if (config.agentType === 'web') {
      this.screen_name = protocol + "://" + host + this.pathname;
    } else {
...
var IMQAConfig = /** @class */function () {
  function IMQAConfig(window) {
    ...
    this.agentType = AgentType.WEB; // agent 타입 web, webview (기본값 WEBVIEW)
...
var IOSCrash_1 = __webpack_require__(4236);
var AOSCrash_1 = __webpack_require__(3884);
...
var _stringify = _interopRequireDefault(__webpack_require__(849));
...
var _stringify = __webpack_require__(849);
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    "default": obj
  };
...
exports["default"] = void 0;
var _v = _interopRequireDefault(__webpack_require__(6125));
var _sha = _interopRequireDefault(__webpack_require__(3511));
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    "default": obj
  };
...
var SPAOnLoadWindowManager_1 = __webpack_require__(5891);
...
function main(window) {
  ...
  if (agent.isConnect()) {
    ...
    // const DOMOnRender = new OnRender();
